...
/*:::::::::::::::::::::start video:::::::::::::::::::::*/
  let playButton = document.querySelector('.video-container a');
    ...
    function playVideo(e) {
      ...
      videoContainer.innerHTML = `<iframe class="video-la" src="https://www.youtube.com/watch?v=DvcBxEgXtkU" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>`;
    }
/*:::::::::::::::::::::end video:::::::::::::::::::::*/
...
record.onclick = e => {
  if (record.classList.contains('active')) {
    ...
    $('._inner').removeClass('_playActive-inner');
    $('._outer').removeClass('_playActive-outer');
    record.style.backgroundColor = "#0d47a1";
    rec.stop();
  } else {
    record.classList.add('active');
    record.style.backgroundColor = "#0d47a1";
    $('._inner').addClass('_playActive-inner');
    $('._outer').addClass('_playActive-outer');
    audioChunks = [];
    rec.start();
  }
}
